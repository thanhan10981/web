...
if(isset($_GET['maphim'])) {
    ...
    $sql = "DELETE FROM lich_chieu WHERE maphim='$maphim'";

    // Thực hiện truy vấn SQL để xóa phim
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Xóa phim thành công.'); setTimeout(function(){ window.location.href = '../php/lich_chieu.php'; }, 100);</script>";
