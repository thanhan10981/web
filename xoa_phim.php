...
<body> 
    <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            <li><a href="#"><i class="fa-solid fa-trash"></i> Xóa Phim</a></li>
        ...
        <div class="name-home">
            <h3><i class="fa-solid fa-trash-can"></i> XỬ LÝ XÓA PHIM</h3>
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . $row["mota"] . "</td>";
                        echo "<th> <a href='../php/xu_ly_xoaphim.php?maphim=" . $row["maphim"] . "'>Xóa <i class='fa-solid fa-trash'></i></a></th>";
                        echo "</tr>";
                }
                echo "</table>";
            } else {
